...
const navSections = [
  ...
  { label: "Communities", href: "/products/entry/communities", indent: true },
  { label: "Activation Queue", href: "/products/entry/activation", indent: true },
  { label: "Users", href: "/products/entry/users", indent: true },
  { label: "Settings", href: "/products/entry/settings", indent: true },
