...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050505] px-4 py-8 sm:px-6">
      ...
      <section className="relative grid w-full max-w-5xl overflow-hidden rounded-2xl border border-white/10 bg-[#0a0a0a] shadow-[0_28px_100px_rgba(0,0,0,0.58)] lg:grid-cols-[1.12fr_0.88fr]">
        <div className="relative flex min-h-[260px] flex-col items-center justify-center border-b border-white/8 p-7 sm:p-10 lg:min-h-[440px] lg:border-b-0 lg:border-r">
          ...
          <div className="relative">
            <div className="flex max-w-[32rem] justify-center">
              <Image
                ...
                height={220}
                priority
                className="h-auto w-[330px] sm:w-[420px]"
              />
            </div>
          </div>
        </div>
