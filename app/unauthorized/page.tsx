...
import { DEFAULT_POST_LOGIN_DESTINATION, MEMBER_POST_LOGIN_DESTINATION } from "@/features/auth/postLoginDestination";
...
export default async function UnauthorizedPage({
  ...
  const badgeText = isAuthorizationError || isSignOutError
