...
const migrationSuffix = "_create_entry_community_registration_review_v1.sql";
...
const backendV1Path = migrationPathBySuffix(
...
const backendV1Head = execFileSync("git", [
  "show",
  `HEAD:${headMigrationBySuffix("_create_entry_community_registration_backend_v1.sql")}`,
], { encoding: "utf8" });
